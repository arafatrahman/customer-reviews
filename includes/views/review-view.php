    ...
    public function display_reviews($reviews, $counts, $current_status) {
        ...
        if (!empty($paged_reviews)) {
            foreach ($paged_reviews as $review) {
                ...
                if ($review->status !== 'rejected') {
                    echo "<td>
                            <button type='button' class='button reply-now' data-review-id='{$review->id}' data-review-author='{$review->name}' data-reply-message='{$review->admin_reply}'>Reply</button>
                            ...
                            data-review-city='{$review->city}' data-review-state='{$review->state}' data-review-positionid='{$review->positionid}'>Edit Review</button>
                          </td>";
                } else {
                    echo "<td></td>";
                }
        ...
        echo '<div id="cr-edit-review-popup" style="width:40%;display:none;position:fixed; top:50%; left:50%; transform:translate(-50%, -50%); background:#fff; padding:20px; box-shadow:0 0 10px rgba(0,0,0,0.5); z-index:1000;">
                ...
                <form id="edit-review-form">
                    ...
                    <p><label for="edit-review-name"><strong>Review Author:</strong></label><br><input type="text" name="review_name" id="edit-review-name" style="width:100%;"></p>
                    <p><label for="edit-review-email"><strong>Review Email:</strong></label><br><input type="email" name="review_email" id="edit-review-email" style="width:100%;"></p>
                    <p><label for="edit-review-website"><strong>Review Website:</strong></label><br><input type="url" name="review_website" id="edit-review-website" style="width:100%;"></p>
                    <p><label for="edit-review-phone"><strong>Review Phone:</strong></label><br><input type="tel" name="review_phone" id="edit-review-phone" style="width:100%;"></p>
                    <p><label for="edit-review-city"><strong>Review City:</strong></label><br><input type="text" name="review_city" id="edit-review-city" style="width:100%;"></p>
                    <p><label for="edit-review-state"><strong>Review State:</strong></label><br><input type="text" name="review_state" id="edit-review-state" style="width:100%;"></p>
                    <p><label for="edit-review-title"><strong>Review Title:</strong></label><br><input type="text" name="review_title" id="edit-review-title" style="width:100%;"></p>
                    <p><label for="edit-review-comment"><strong>Review Comment:</strong></label><br><textarea name="review_comment" id="edit-review-comment" rows="5" style="width:100%;"></textarea></p>
                    <p><label for="edit-review-rating"><strong>Rating:</strong></label><br>
                    ...
                    <p><label for="edit-review-status"><strong>Status:</strong></label><br>
                    ...
                    <p><label for="edit-review-positionid"><strong>Reviewed Display Post/Page:</strong></label><br>
